...
SELECT
	...
	COALESCE(ya.month_start, DATE_TRUNC('month', da.date)) AS month_start,  --DATE_TRUNC is like rounding
...
ON CONFLICT (user_id, month_start, metric_name)  -- UPSERT syntax: ON CONFLICT ... DO UPDATE SET {}=EXCLUDED.{}
DO 
